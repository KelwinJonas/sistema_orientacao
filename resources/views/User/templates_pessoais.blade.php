            ...
            <div class="row justify-content-center">
                <div class="col-md-10">
                        ...
                        <div class="col-md-12" style="margin-top: 20px;">
                            <div class="row align-items-start">
                                ...
                                <div class="col" style="text-align: right;">
                                    <a href="{{route('templates.pessoais.novo')}}" class="btn btn-primary btn-sm" style="margin-top: 5px;">Adicionar</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                    ...
                    @foreach(Auth::user()->templates_pessoais as $template)
                        <div class="col-md-12 style_card_pessoas_atividade" onclick="document.location='{{route('templates.pessoais.ver', $template->id)}}'">
                            <div class="row align-items-start">
