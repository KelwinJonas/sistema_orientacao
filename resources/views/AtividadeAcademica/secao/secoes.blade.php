        ...
        <div class="container" id="container-ver-atividade">
            ...
            <div class="row justify-content-center">
                                    ...
                                    <div class="row">
                                        ...
                                        @if($atividade->secoes->count() == 0)
                                            ...
                                            <p class="col">
                                                ...
                                                <br>
                                                <a id="botao-criar-secao"
                                                   data-toggle="modal"
                                                   data-target="#modal-criar-secao"
                                                   style="text-align:right; font-size: 15px; color: blue;"
                                                   onclick="add_id_na_subsecao(null)">
                                                    Clique aqui
                                                </a>
                ...
                @if(session("localizacao_erro") == "editar" && isset($secao))
                    ...
                    <script>$("#modal-editar-secao").modal("show");</script>
                ...
                @if(isset($secao))
                    ...
                    <div class="col-md-7">
                        <div class="row" style="padding: 5px;">
                            <div class="col-md-12 style_secao"
                                 style="display: inline; padding-top: 5px; padding-bottom: 5px;"
                                 id="id_area_secao">

                                <span style="position: relative; top: 10px;">{{$secao->nome}}</span>
                                
                                <button id="btn_dropdown_opcoes_secao"
